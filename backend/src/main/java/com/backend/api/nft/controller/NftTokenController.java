            ...
            @ApiResponse(responseCode = "에러", description = "#### 에러 이유를 확인 하십시오",
                    content =@Content(schema = @Schema(implementation = ErrorResponse.class),
                            examples = {@ExampleObject( name = "401_Auth-006", value = "Authorization Header가 없습니다. 자물쇠에 access token값을 넣어주세요."),
                                    ...
                                    @ExampleObject( name = "400_NFT-002", value = "이미 발행된 토큰입니다."),
                                    @ExampleObject( name = "401_NFT-003", value = "본인이 그린 그림만 NFT 발행할 수 있습니다."),
                                    @ExampleObject( name = "404_NFT-001", value = "지갑을 찾을 수 없습니다. NFT 지갑발급으로 돌아가 지갑을 생성해 주세요."),
